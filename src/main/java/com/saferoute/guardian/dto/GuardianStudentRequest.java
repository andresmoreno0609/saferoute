package com.saferoute.guardian.dto;
...
/**
 * Request DTO for creating/updating a student by guardian.
 * Contains student data + relationship info.
 */
public record GuardianStudentRequest(
    // Student data
