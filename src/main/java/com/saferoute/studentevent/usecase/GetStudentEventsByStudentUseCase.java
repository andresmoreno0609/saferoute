...
@Slf4j
public class GetStudentEventsByStudentUseCase extends UseCaseAdvance<UUID, List<StudentEventResponse>> {
    private final StudentEventService service;

    @Override
    protected List<StudentEventResponse> core(UUID studentId) {
