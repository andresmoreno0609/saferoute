...
@Slf4j
public class GetNotificationsByGuardianUseCase extends UseCaseAdvance<UUID, List<NotificationResponse>> {
    private final NotificationService service;

    @Override
    protected List<NotificationResponse> core(UUID guardianId) {
        log.debug("Getting notifications for guardian: {}", guardianId);
